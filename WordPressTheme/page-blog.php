    ...
    <div class="l-inner">
      <div class="p-sub-blog__category p-category">
        <ul class="p-category__items">
          <li class="p-category__item p-category__item--active"><a href="#">ALL</a></li>
          <li class="p-category__item"><a href="<?php echo esc_url(home_url('/blog_category/category1')); ?>">カテゴリ１</a></li>
          <li class="p-category__item"><a href="<?php echo esc_url(home_url('/blog_category/categorycategory')); ?>">カテゴリカテゴリ</a></li>
      ...
      <div class="p-sub-blog__cards p-card-list01">
        ...
        $args  = array(
          'paged' => $paged,
          'post_type'      => 'blog1',  //カスタム投稿タイプのスラッグ
          'posts_per_page' => 9,
        );
              ...
              <a href="<?php the_permalink(); ?>">
                ...
                <div class="p-card-style01__body">
                  <div class="p-card-style01__contents">
                    <h2 class="p-card-style01__title"><?php the_title(); ?></h2>
