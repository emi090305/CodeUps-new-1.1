    ...
    <div class="l-inner">
      <div class="p-sub-works__category p-category">
        <ul class="p-category__items">
          ...
          <li class="p-category__item p-category__item--active"><a href="#">コーポレートサイト</a></li>
          <li class="p-category__item"><a href="<?php echo esc_url(home_url('/works_category/ec-site')); ?>">ECサイト</a></li>
        </ul>
      </div>
    </div>
